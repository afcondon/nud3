...
type Node = { id :: Int, x :: Number, y :: Number, vx :: Number, vy :: Number, mass :: Number } 
...
onTickNode :: Engine -> Array Node -> Array Attribute -> Effect Unit
onTickNode engine nodes attrs = do
  pure unit

onTickLink :: Engine -> Array Link -> Array Attribute -> Effect Unit
